package hibernate;
// Generated 27-feb-2016 20:20:18 by Hibernate Tools 4.3.1
...
public class Keep  implements java.io.Serializable {
    ...
    public String toString() {
        return "Keep{" + "id=" + id + ", usuario=" + usuario + ", idAndroid=" + idAndroid + ", contenido=" + contenido + ", ruta=" + ruta + ", estado=" + estado + '}';
    }
